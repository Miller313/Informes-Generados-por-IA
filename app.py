...
user_email = st.text_input("Tu Correo de Google", help="Tu email personal (ej. tu@gmail.com). El informe se transferirá a tu propiedad.")
...
with st.form("report_form"):
    ...
    # --- AQUÍ SE DEFINE 'submitted' ---
    submitted = st.form_submit_button("Generar Informe en Google Docs")

# --- LÓGICA DE GENERACIÓN (AQUÍ SE USA 'submitted') ---
if submitted:
